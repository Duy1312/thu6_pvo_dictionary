...
namespace thu6_pvo_dictionary.Services
{
            ...
            var claimList = new List<Claim>
    {
        ...
        private void SendEmail(string recipient, string subject, string body)
        {
            try
            {
                using (var mail = new MailMessage("nguyenmanhduyhy1312@gmail.com", recipient, subject, body))
                {
                    ...
                    using (var client = new SmtpClient("smtp.gmail.com"))
                    {
                        ...
                        client.Port = 587;
                        client.Credentials = new System.Net.NetworkCredential("nguyenmanhduyhy1312@gmail.com", "isccnxilegojiclr");
